 ...
 */
const srcCommit = {
    ar: { id: "2808418f", finishId: [] }, // 阿拉伯语
    en: { id: "2808418f", finishId: [] }, // 英语
    eo: { id: "2808418f", finishId: [] }, // 世界语
    es: { id: "2808418f", finishId: [] }, // 西班牙语
    fr: { id: "2808418f", finishId: [] }, // 法语
    ru: { id: "2808418f", finishId: [] }, // 俄语
    "zh-HANT": { id: "2808418f", finishId: [] }, // 繁体中文
};
