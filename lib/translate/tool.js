 ...
 */
const srcCommit = {
    ar: { id: "fc49491d", finishId: [] }, // 阿拉伯语
    en: { id: "fc49491d", finishId: [] }, // 英语
    eo: { id: "fc49491d", finishId: [] }, // 世界语
    es: { id: "fc49491d", finishId: [] }, // 西班牙语
    fr: { id: "fc49491d", finishId: [] }, // 法语
    ru: { id: "fc49491d", finishId: [] }, // 俄语
    "zh-HANT": { id: "fc49491d", finishId: [] }, // 繁体中文
};
