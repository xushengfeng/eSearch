 ...
 */
const srcCommit = {
    ar: { id: "cf68cccc", finishId: [] }, // 阿拉伯语
    en: { id: "cf68cccc", finishId: [] }, // 英语
    eo: { id: "cf68cccc", finishId: [] }, // 世界语
    es: { id: "cf68cccc", finishId: [] }, // 西班牙语
    fr: { id: "cf68cccc", finishId: [] }, // 法语
    ru: { id: "cf68cccc", finishId: [] }, // 俄语
    "zh-HANT": { id: "cf68cccc", finishId: [] }, // 繁体中文
};
...
if (getAllStr) {
    ...
    if (!allStrFile) {
        ...
        console.log(Array.from(unUse).join("\n"));
    }
}
