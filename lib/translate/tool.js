 ...
 */
const srcCommit = {
    ar: { id: "115b9f61", finishId: [] }, // 阿拉伯语
    en: { id: "115b9f61", finishId: [] }, // 英语
    eo: { id: "115b9f61", finishId: [] }, // 世界语
    es: { id: "115b9f61", finishId: [] }, // 西班牙语
    fr: { id: "115b9f61", finishId: [] }, // 法语
    ru: { id: "115b9f61", finishId: [] }, // 俄语
    "zh-HANT": { id: "115b9f61", finishId: [] }, // 繁体中文
};
