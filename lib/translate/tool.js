 ...
 */
const srcCommit = {
    ar: { id: "d5b90ef6", finishId: [] }, // 阿拉伯语
    en: { id: "d5b90ef6", finishId: [] }, // 英语
    eo: { id: "d5b90ef6", finishId: [] }, // 世界语
    es: { id: "d5b90ef6", finishId: [] }, // 西班牙语
    fr: { id: "d5b90ef6", finishId: [] }, // 法语
    ru: { id: "d5b90ef6", finishId: [] }, // 俄语
    "zh-HANT": { id: "d5b90ef6", finishId: [] }, // 繁体中文
};
