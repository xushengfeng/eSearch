 ...
 */
const srcCommit = {
    ar: { id: "b384dddb", finishId: [] }, // 阿拉伯语
    en: { id: "b384dddb", finishId: [] }, // 英语
    eo: { id: "b384dddb", finishId: [] }, // 世界语
    es: { id: "b384dddb", finishId: [] }, // 西班牙语
    fr: { id: "b384dddb", finishId: [] }, // 法语
    ru: { id: "b384dddb", finishId: [] }, // 俄语
    "zh-HANT": { id: "b384dddb", finishId: [] }, // 繁体中文
};
