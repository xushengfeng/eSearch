 ...
 */
const srcCommit = {
    ar: { id: "b6b0f2f6", finishId: [] }, // 阿拉伯语
    en: { id: "b6b0f2f6", finishId: [] }, // 英语
    eo: { id: "b6b0f2f6", finishId: [] }, // 世界语
    es: { id: "b6b0f2f6", finishId: [] }, // 西班牙语
    fr: { id: "b6b0f2f6", finishId: [] }, // 法语
    ru: { id: "b6b0f2f6", finishId: [] }, // 俄语
    "zh-HANT": { id: "b6b0f2f6", finishId: [] }, // 繁体中文
};
