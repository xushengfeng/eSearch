 ...
 */
const srcCommit = {
    ar: { id: "c5637044", finishId: [] }, // 阿拉伯语
    en: { id: "c5637044", finishId: [] }, // 英语
    eo: { id: "c5637044", finishId: [] }, // 世界语
    es: { id: "c5637044", finishId: [] }, // 西班牙语
    fr: { id: "c5637044", finishId: [] }, // 法语
    ru: { id: "c5637044", finishId: [] }, // 俄语
    "zh-HANT": { id: "c5637044", finishId: [] }, // 繁体中文
};
...
if (getAllStr) {
    ...
    // @ts-ignore
    const unAdd = strs.difference(keys);
    console.log(
        Array.from(unAdd).map(
            (i) => `${i}    ${Array.from(strs2files.get(i)).join(", ")}`,
        ),
    );
    // @ts-ignore
    const unUse = keys.difference(strs);
    console.log(Array.from(unUse));
}
