 ...
 */
const srcCommit = {
    ar: { id: "fc73fa35", finishId: [] }, // 阿拉伯语
    en: { id: "fc73fa35", finishId: [] }, // 英语
    eo: { id: "fc73fa35", finishId: [] }, // 世界语
    es: { id: "fc73fa35", finishId: [] }, // 西班牙语
    fr: { id: "fc73fa35", finishId: [] }, // 法语
    ru: { id: "fc73fa35", finishId: [] }, // 俄语
    "zh-HANT": { id: "fc73fa35", finishId: [] }, // 繁体中文
};
