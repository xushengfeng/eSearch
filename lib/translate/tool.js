 ...
 */
const srcCommit = {
    ar: { id: "c582cd65", finishId: [] }, // 阿拉伯语
    en: { id: "c582cd65", finishId: [] }, // 英语
    eo: { id: "c582cd65", finishId: [] }, // 世界语
    es: { id: "c582cd65", finishId: [] }, // 西班牙语
    fr: { id: "c582cd65", finishId: [] }, // 法语
    ru: { id: "c582cd65", finishId: [] }, // 俄语
    "zh-HANT": { id: "c582cd65", finishId: [] }, // 繁体中文
};
