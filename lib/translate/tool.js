 ...
 */
const srcCommit = {
    ar: { id: "984cf7e9", finishId: [] }, // 阿拉伯语
    en: { id: "984cf7e9", finishId: [] }, // 英语
    eo: { id: "984cf7e9", finishId: [] }, // 世界语
    es: { id: "984cf7e9", finishId: [] }, // 西班牙语
    fr: { id: "984cf7e9", finishId: [] }, // 法语
    ru: { id: "984cf7e9", finishId: [] }, // 俄语
    "zh-HANT": { id: "984cf7e9", finishId: [] }, // 繁体中文
};
