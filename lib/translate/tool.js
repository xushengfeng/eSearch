 ...
 */
const srcCommit = {
    ar: { id: "f71a8e33", finishId: [] }, // 阿拉伯语
    en: { id: "f71a8e33", finishId: [] }, // 英语
    eo: { id: "f71a8e33", finishId: [] }, // 世界语
    es: { id: "f71a8e33", finishId: [] }, // 西班牙语
    fr: { id: "f71a8e33", finishId: [] }, // 法语
    ru: { id: "f71a8e33", finishId: [] }, // 俄语
    "zh-HANT": { id: "f71a8e33", finishId: [] }, // 繁体中文
};
