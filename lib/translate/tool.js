 ...
 */
const srcCommit = {
    ar: { id: "d1b8603c", finishId: [] }, // 阿拉伯语
    en: { id: "d1b8603c", finishId: [] }, // 英语
    eo: { id: "d1b8603c", finishId: [] }, // 世界语
    es: { id: "d1b8603c", finishId: [] }, // 西班牙语
    fr: { id: "d1b8603c", finishId: [] }, // 法语
    ru: { id: "d1b8603c", finishId: [] }, // 俄语
    "zh-HANT": { id: "d1b8603c", finishId: [] }, // 繁体中文
};
