...
function get_f_object_v() {
    ...
    var [fill, stroke, stroke_width] = [n.fill, n.stroke, n.strokeWidth];
    document.querySelector("#draw_stroke_width > range-b").value = fabric_canvas.freeDrawingBrush.width = stroke_width;
